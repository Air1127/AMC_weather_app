...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  void initState() {
    super.initState();
    // Load weather for a default city (e.g., London) when the app starts
  ...
  void _searchWeather() {
    ...
    // Update the Future to fetch new weather data and trigger a rebuild
    setState(() {
      weatherFuture = WeatherService.getWeather(city);
    });
  }

  // Helper: Display notification messages (SnackBars)
              ...
              children: [
                ...
                Expanded(
                  child: TextField(
                    ...
                    // Allow pressing "Enter" on the keyboard to search
...
// ===== REUSABLE WIDGET for weather info cards =====
